    ...
    def post(self, request):
        ...
        if permissions:
            ...
            try:
                ...
                created_group.delete()
                raise APIException('Envie as permisões no padrão correto.')
...
class GroupDetail(Base):
    ...
    def put(self, request, group_id):
        ...
        Group_Permissions.objects.filter(id=group_id).delete()
    ...
    def delete(self, request, group_id):
        ...
        Group.objects.filter(
            id=group_id, enterprise_id=enterprise_id). delete()
