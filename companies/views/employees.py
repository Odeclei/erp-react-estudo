...
class EmployeeDatail(Base):
    ...
    def put(self, request, employee_id):
        ...
        if email != employee.user.email and User.objects.filter(
                email=email).exists():
            raise APIException("Esse email já utilizado",
